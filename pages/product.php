...
"https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js"></script>
  ...
  content="width=device-width, initial-scale=1.0">
    ...
    <style>
        ...
        <?php include 'CSS/button_style.css'; ?>
    </style>
</head>
...
<body>
    <nav class="navbar navbar-expand-sm navbar-light bg-success">
        <div class="container">
            <a class="navbar-brand" href="#" style="font-weight:bold; color:white;">Product</a>
    ...
    <div>
        <h2 class="p-4 mt-5">Welcome To Product</h2>
    </div>
<!-- JS script with button example -->
